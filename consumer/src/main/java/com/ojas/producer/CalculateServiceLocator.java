...
public class CalculateServiceLocator extends org.apache.axis.client.Service implements com.ojas.producer.CalculateService {
    ...
    private java.lang.String Calculate_address = "http://localhost:8080/WebServicesproducer/services/Calculate";
    ...
    public com.ojas.producer.Calculate getCalculate(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ojas.producer.CalculateSoapBindingStub _stub = new com.ojas.producer.CalculateSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ojas.producer.Calculate.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ojas.producer.CalculateSoapBindingStub _stub = new com.ojas.producer.CalculateSoapBindingStub(new java.net.URL(Calculate_address), this);
                _stub.setPortName(getCalculateWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://producer.ojas.com", "CalculateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://producer.ojas.com", "Calculate"));
        }
