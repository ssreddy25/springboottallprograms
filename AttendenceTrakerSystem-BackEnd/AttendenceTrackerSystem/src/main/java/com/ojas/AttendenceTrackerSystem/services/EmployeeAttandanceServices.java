...
public class EmployeeAttandanceServices {
	...
	public List<EmployeeAttadance> getAttadanceList(String name ,String startdate, String endDate){
		
		return employeeAttandaceRepositroy.getByNameAndDate(name, startdate, endDate);
