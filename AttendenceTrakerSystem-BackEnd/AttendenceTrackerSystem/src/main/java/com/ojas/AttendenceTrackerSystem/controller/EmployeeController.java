...
public class EmployeeController {
	...
	public String  saveAllEmployeeAttadanceDetails(@RequestBody List<EmployeeAttadance> attandace) {
     ...
     @GetMapping("/getAttedance/{name}/{startDate}/{endDate}")
	public List<EmployeeAttadance> getattedanceBetweenDate(@PathVariable String name,@PathVariable String startDate,@PathVariable String endDate){
		
		return employeeAttandanceServices.getAttadanceList(name, startDate, endDate);
	}
}
